...
SOURCES= book.txt async-finish.txt futures.txt preliminaries.txt background.txt dedicated.txt graph-theory.txt graphs.txt  models.txt multithreading.txt mutual-exclusion.txt fork-join.txt scheduling.txt benchmarking.txt intro.txt  preface.txt work-efficiency.txt granularity-control.txt parallel-arrays.txt sorting.txt synchronization.txt trees.txt work-stealing.txt graphs.txt
